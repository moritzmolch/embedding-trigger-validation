...
class BaseTask(law.Task):
    ...
    local_store_path = luigi.PathParameter(
        exists=False,
        description="path to the local file store for task outputs; default: '{}".format(os.environ["ETV_STORE_PATH"]),
...
class ConfigTask(BaseTask):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config_inst = ConfigManager().load_config(os.path.join(os.environ["ETV_CONFIG_PATH"], "analysis", self.config))
